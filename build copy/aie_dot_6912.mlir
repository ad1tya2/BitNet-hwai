module {
  aie.device(npu1) {
    ...
    aie.objectfifo @in1_0(%shim_noc_tile_0_0, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<1728xui8>> 
    aie.objectfifo @in1_1(%shim_noc_tile_0_0, {%tile_0_3}, 2 : i32) : !aie.objectfifo<memref<1728xui8>> 
    aie.objectfifo @in1_2(%shim_noc_tile_1_0, {%tile_0_4}, 2 : i32) : !aie.objectfifo<memref<1728xui8>> 
    aie.objectfifo @in1_3(%shim_noc_tile_1_0, {%tile_0_5}, 2 : i32) : !aie.objectfifo<memref<1728xui8>> 
    aie.objectfifo @in2_0(%shim_noc_tile_2_0, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<6912xi8>> 
    aie.objectfifo @in2_1(%shim_noc_tile_2_0, {%tile_0_3}, 2 : i32) : !aie.objectfifo<memref<6912xi8>> 
    aie.objectfifo @in2_2(%shim_noc_tile_3_0, {%tile_0_4}, 2 : i32) : !aie.objectfifo<memref<6912xi8>> 
    aie.objectfifo @in2_3(%shim_noc_tile_3_0, {%tile_0_5}, 2 : i32) : !aie.objectfifo<memref<6912xi8>> 
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c1_1 step %c1_2 {
          %0 = aie.objectfifo.acquire @in1_0(Consume, 1) : !aie.objectfifosubview<memref<1728xui8>>
          %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<1728xui8>> -> memref<1728xui8>
          %2 = aie.objectfifo.acquire @in2_0(Consume, 1) : !aie.objectfifosubview<memref<6912xi8>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<6912xi8>> -> memref<6912xi8>
          ...
          func.call @dot_product_i2_i8_6912(%1, %3, %5) : (memref<1728xui8>, memref<6912xi8>, memref<1xf32>) -> ()
    ...
    %core_0_3 = aie.core(%tile_0_3) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_2 = arith.constant 1 : index
        scf.for %arg1 = %c0_0 to %c1_1 step %c1_2 {
          %0 = aie.objectfifo.acquire @in1_1(Consume, 1) : !aie.objectfifosubview<memref<1728xui8>>
          %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<1728xui8>> -> memref<1728xui8>
          %2 = aie.objectfifo.acquire @in2_1(Consume, 1) : !aie.objectfifosubview<memref<6912xi8>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<6912xi8>> -> memref<6912xi8>
    ...
    %core_0_4 = aie.core(%tile_0_4) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_2 = arith.constant 1 : index
        scf.for %arg1 = %c0_0 to %c1_1 step %c1_2 {
          %0 = aie.objectfifo.acquire @in1_2(Consume, 1) : !aie.objectfifosubview<memref<1728xui8>>
          %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<1728xui8>> -> memref<1728xui8>
          %2 = aie.objectfifo.acquire @in2_2(Consume, 1) : !aie.objectfifosubview<memref<6912xi8>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<6912xi8>> -> memref<6912xi8>
    ...
    %core_0_5 = aie.core(%tile_0_5) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_2 = arith.constant 1 : index
        scf.for %arg1 = %c0_0 to %c1_1 step %c1_2 {
          %0 = aie.objectfifo.acquire @in1_3(Consume, 1) : !aie.objectfifosubview<memref<1728xui8>>
          %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<1728xui8>> -> memref<1728xui8>
          %2 = aie.objectfifo.acquire @in2_3(Consume, 1) : !aie.objectfifosubview<memref<6912xi8>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<6912xi8>> -> memref<6912xi8>
