module attributes {llvm.target_triple = "aie2"} {
  llvm.mlir.global external @in1_0_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<640 x i8>
  llvm.mlir.global external @in1_0_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<640 x i8>
  llvm.mlir.global external @in1_1_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<640 x i8>
  llvm.mlir.global external @in1_1_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<640 x i8>
  llvm.mlir.global external @in1_2_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<640 x i8>
  llvm.mlir.global external @in1_2_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<640 x i8>
  llvm.mlir.global external @in1_3_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<640 x i8>
  llvm.mlir.global external @in1_3_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<640 x i8>
  llvm.mlir.global external @in2_0_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<2560 x i8>
  llvm.mlir.global external @in2_0_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<2560 x i8>
  llvm.mlir.global external @in2_1_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<2560 x i8>
  llvm.mlir.global external @in2_1_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<2560 x i8>
  llvm.mlir.global external @in2_2_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<2560 x i8>
  llvm.mlir.global external @in2_2_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<2560 x i8>
  llvm.mlir.global external @in2_3_cons_buff_1() {addr_space = 0 : i32} : !llvm.array<2560 x i8>
  llvm.mlir.global external @in2_3_cons_buff_0() {addr_space = 0 : i32} : !llvm.array<2560 x i8>
  ...
  llvm.func @dot_product_i2_i8_2560(!llvm.ptr, !llvm.ptr, !llvm.ptr) attributes {sym_visibility = "private"}
  llvm.func @core_0_5() {
  ...
  ^bb2:  // pred: ^bb1
    ...
    %20 = llvm.getelementptr %4[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2560 x i8>
    %21 = llvm.getelementptr %3[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<640 x i8>
    llvm.call @dot_product_i2_i8_2560(%21, %20, %19) : (!llvm.ptr, !llvm.ptr, !llvm.ptr) -> ()
    ...
    %23 = llvm.getelementptr %1[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2560 x i8>
    %24 = llvm.getelementptr %0[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<640 x i8>
    llvm.call @dot_product_i2_i8_2560(%24, %23, %22) : (!llvm.ptr, !llvm.ptr, !llvm.ptr) -> ()
    llvm.call @llvm.aie2.release(%10, %14) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%9, %14) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%8, %14) : (i32, i32) -> ()
  ...
  ^bb3:  // pred: ^bb1
    ...
    %27 = llvm.getelementptr %4[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<2560 x i8>
    %28 = llvm.getelementptr %3[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<640 x i8>
    llvm.call @dot_product_i2_i8_2560(%28, %27, %26) : (!llvm.ptr, !llvm.ptr, !llvm.ptr) -> ()
    llvm.call @llvm.aie2.release(%10, %14) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%9, %14) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%8, %14) : (i32, i32) -> ()
    llvm.return
