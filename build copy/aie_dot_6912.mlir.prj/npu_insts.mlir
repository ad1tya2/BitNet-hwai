module {
  aie.device(npu1) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      aie.end
    } {elf_file = "/notebooks/aditya.shankar/hwai-proj-mlir-aie/programming_examples/basic/dot_product/build/aie_dot_6912.mlir.prj/main_core_0_2.elf", link_with = "dot.o"}
    %core_0_3 = aie.core(%tile_0_3) {
      aie.end
    } {elf_file = "/notebooks/aditya.shankar/hwai-proj-mlir-aie/programming_examples/basic/dot_product/build/aie_dot_6912.mlir.prj/main_core_0_3.elf", link_with = "dot.o"}
    %core_0_4 = aie.core(%tile_0_4) {
      aie.end
    } {elf_file = "/notebooks/aditya.shankar/hwai-proj-mlir-aie/programming_examples/basic/dot_product/build/aie_dot_6912.mlir.prj/main_core_0_4.elf", link_with = "dot.o"}
    %core_0_5 = aie.core(%tile_0_5) {
      aie.end
    } {elf_file = "/notebooks/aditya.shankar/hwai-proj-mlir-aie/programming_examples/basic/dot_product/build/aie_dot_6912.mlir.prj/main_core_0_5.elf", link_with = "dot.o"}
    memref.global "private" constant @blockwrite_data_0 : memref<8xi32> = dense<[432, 0, 0, 0, -2147483648, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[1728, 0, 0, 0, -2147483648, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_2 : memref<8xi32> = dense<[432, 1728, 0, 0, -2147483648, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_3 : memref<8xi32> = dense<[1728, 6912, 0, 0, -2147483648, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_4 : memref<8xi32> = dense<[432, 3456, 0, 0, -2147483648, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_5 : memref<8xi32> = dense<[1728, 13824, 0, 0, -2147483648, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_6 : memref<8xi32> = dense<[432, 5184, 0, 0, -2147483648, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_7 : memref<8xi32> = dense<[1728, 20736, 0, 0, -2147483648, 33554432, 0, 33554432]>
    ...
    aiex.runtime_sequence(%arg0: memref<6912xui8>, %arg1: memref<27648xi8>, %arg2: memref<4xf32>) {
      ...
      aiex.npu.address_patch {addr = 118820 : ui32, arg_idx = 0 : i32, arg_plus = 1728 : i32}
      ...
      aiex.npu.address_patch {addr = 67227684 : ui32, arg_idx = 1 : i32, arg_plus = 6912 : i32}
      ...
      aiex.npu.address_patch {addr = 33673220 : ui32, arg_idx = 0 : i32, arg_plus = 3456 : i32}
      ...
      aiex.npu.address_patch {addr = 100782084 : ui32, arg_idx = 1 : i32, arg_plus = 13824 : i32}
      ...
      aiex.npu.address_patch {addr = 33673252 : ui32, arg_idx = 0 : i32, arg_plus = 5184 : i32}
      ...
      aiex.npu.address_patch {addr = 100782116 : ui32, arg_idx = 1 : i32, arg_plus = 20736 : i32}
