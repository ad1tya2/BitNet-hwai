module {
  aie.device(npu1) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      aie.end
    } {elf_file = "/notebooks/aditya.shankar/hwai-proj-mlir-aie/programming_examples/basic/dot_product/build/aie_dot.mlir.prj/main_core_0_2.elf", link_with = "dot.o"}
    %core_0_3 = aie.core(%tile_0_3) {
      aie.end
    } {elf_file = "/notebooks/aditya.shankar/hwai-proj-mlir-aie/programming_examples/basic/dot_product/build/aie_dot.mlir.prj/main_core_0_3.elf", link_with = "dot.o"}
    %core_0_4 = aie.core(%tile_0_4) {
      aie.end
    } {elf_file = "/notebooks/aditya.shankar/hwai-proj-mlir-aie/programming_examples/basic/dot_product/build/aie_dot.mlir.prj/main_core_0_4.elf", link_with = "dot.o"}
    %core_0_5 = aie.core(%tile_0_5) {
      aie.end
    } {elf_file = "/notebooks/aditya.shankar/hwai-proj-mlir-aie/programming_examples/basic/dot_product/build/aie_dot.mlir.prj/main_core_0_5.elf", link_with = "dot.o"}
